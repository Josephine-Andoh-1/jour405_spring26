...
The correlation matrix shows that a handful of the variables are correlated. The percentage of people with a bachelor's degree or higher and income has a relatively positive correlation. The percentage of people with a bachelor's degree or higher and voter turnout are also relatively positively correlated. On the other hand, the percentage of white people and population have a relatively negative correlation. Unemployment and voter turnout are also relatively negatively correlated. The percentage of white people and income are almost completely uncorrelated, and so are the percentage of people with a bachelor's degree or higher and median age.

The scatterplots show that all the independent variables seem to have a linear relationship with the dependent variable, but some relationships are stronger than others. Income, unemployment, the percentage of people with a bachelor's degree or higher and the percentage of white people seem to have a relatively strong relationship with voter turnout. On the other hand, median age and population seem to have a relatively weaker relationship with voter turnout.
...
This multiple variable model predicts voter turnout rather accurately, according to its output. The model overall is statistically significant, and so are the coefficients of all the independent variables. The range of the model's residuals is very small, and its median is almost zero.


However, according to the model, unemployment and higher education levels are not statistically significant.


- statistically significant
- high multiple and adjusted r-squared
- very low residual standard error 
- min and max are very low
- median is almost 0 (implies accuracy)
- all variables have statistically significant coefficients 
