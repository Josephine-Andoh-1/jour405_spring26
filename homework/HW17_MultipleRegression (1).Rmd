...
The range of the model's residuals is very small, and its median is almost zero. It has a very low residual standard error and high multiple and adjusted R-squared values. The model also has a high F-statistic. Based on what I've seen, this model is useful because most of its values indicate accuracy.
