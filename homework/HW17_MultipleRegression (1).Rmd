...
This multiple variable model predicts voter turnout rather accurately, according to its output. The model overall is statistically significant, and so are the relationship between income, median age or the percentage of white people in a county and voter turnout. However, according to the model, the relationship between population, higher education levels or unemployment and voter turnout are not statistically significant.
