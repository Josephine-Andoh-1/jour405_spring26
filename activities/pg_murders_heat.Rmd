...
The correlation calculation shows that an increase in temperatures in Prince George's County appears to be somewhat positively related to the number of murders that occur. However, the scatterplot challenges this theory because August, a hot month in Prince George's County, has a lower number of murders than expected.
