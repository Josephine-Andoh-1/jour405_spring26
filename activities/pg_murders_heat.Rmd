...
The correlation calculation and scatterplot show that an increase in temperatures in Prince George's County appears to be somewhat positively related to the number of murders that occur.
