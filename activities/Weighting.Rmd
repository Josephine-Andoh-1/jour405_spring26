...
The weights in this dataset range from 0.2298 to 3.0386.


2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

When a respondent has a weight of 0.23, it means that their response counts as if they were 23% of a person. However, when a respondent has a weight of 3.04, it means that their response counts as if they were 304% of a person.


3. Why might some respondents be weighted more heavily than others?

Some respondents are weighted more heavily than others if the groups they are in are underrepresented in the poll's sample relative to the population.
...
The voter category that shows the biggest difference between weighted and unweighted results is those who rarely or never vote.


2. How might these differences affect reporting on likely voter turnout?

These differences affect reporting on likely voter turnout because they make it less accurate. For example, since the percentage of those who rarely or never vote is underrepresented, if many people from that voter group decide to vote in the next election, journalists will underestimate what percentage of them will vote. Consequently, if their turnout swings an election one way or another, journalists will be caught by surprise.
...
I think these differences exist because all surveys are samples of the general population, and extrapolations based on samples will never be completely accurate. This survey's results tell us that nonvoters in all three categories who are planning to vote and nonvoters who always vote are overrepresented in the sample. However, nonvoters in all three categories who are unsure of voting, those who rarely or never vote who do not plan to vote and sporadic voters who do not plan to vote are underrepresented in the sample.
