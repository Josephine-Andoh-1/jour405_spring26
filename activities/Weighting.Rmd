...
When a respondent has a weight of 0.23, it means that they count as 23% of a person in analysis. However, when a respondent has a weight of 3.04, it means that they count as 304% of a person in analysis.
...
These differences affect reporting on likely voter turnout because they make it more inaccurate. If those who rarely, never or sporadically vote decide to vote in a particular election, their presence is likely to surprise reporters and make them underestimate turnout percentages. On the other hand, if those who always vote decide not to vote in a particular election, reporters are likely to overestimate turnout percentages.
...
I think these differences exist because voter behavior cannot be perfectly predicted. Those who do not consistently vote can change their minds at a whim, and since they have a history of not voting, pollsters are less likely to understand their voting behavior. Consequently, this tells us that those who rarely or never vote are underrepresented in the sample.
